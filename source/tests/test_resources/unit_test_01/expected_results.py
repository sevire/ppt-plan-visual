...
expected_results_01 = {
    ...
    "plan_data": [
        ...
        ("Activity", "Activity 01", [(360000, 720000, 11103097, 180000, 32), (360000, 720000, 11103097, 180000, "Transparent")]),
        ("Activity", "Activity 02", [(576000, 720000, 11103097, 396000, 32), (576000, 720000, 11103097, 396000, "Transparent")]),
        ("Activity", "Activity 03", [(1008000, 1090103, 10732994, 612000, 32), (1008000, 1090103, 10732994, 612000, "Transparent")]),
        ("Activity", "Activity 04", [(1656000, 1460206, 740206, 180000, 192), (1656000, 2200413, 5921652, 180000, 32), (1656000, 1460206, 6661858, 180000, "Transparent")]),
    ]
}
